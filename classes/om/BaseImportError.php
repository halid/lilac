...
include_once 'ImportErrorPeer.php';

/**
 * Base class that represents a row from the 'import_error' table.
 *
 * Import Job Errors
 *
 * @package    .om
 */
abstract class BaseImportError extends BaseObject  implements Persistent {
